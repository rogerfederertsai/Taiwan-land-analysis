            ...
            if os.path.exists(geojson_path):
                ...
                if not gdf.empty:
                    ...
                    for _, row in gdf.iterrows():
                        ...
                        # 🚀 維持您的動態縮放 vw 標籤設計
                        label_html = f"""<div style="font-family: 'Noto Sans TC', 'Microsoft JhengHei', sans-serif; text-align: center; width: 120px; color: black; text-shadow: 1px 1px 2px white; pointer-events: none;">
                    ...
                    # 🚀 效能修正關鍵：加入 returned_objects=[] 防止數據回傳過大導致變白
